...
public class ProcessingRest {
    private final ProcessingRepository repo;
    ...
    @Autowired
    public ProcessingRest(ProcessingRepository repo, AccountServiceClient accountServiceClient, CardServiceClient cardServiceClient) {
        this.repo = repo;
